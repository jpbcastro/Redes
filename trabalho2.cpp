...
struct bloco{			//bloco que possuirá bits de um caractere "byte", a paridade para controle de erro por paridade "paridade",
	bitset<8> byte;		//	e o resto para controle de erro por CRC "R"
	int paridade;
	bitset<32> R;
};
